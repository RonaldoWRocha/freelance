...
*
*/
define('APP_BASE_URL', 'https://www.paladiniadv.com.br/crm_paladini/');
...
*/
define('APP_ENC_KEY', '9606cdda37976851b9d8e5310936d48f');

/**
 * Database Credentials
 * The hostname of your database server
 */
define('APP_DB_HOSTNAME', 'crm_paladini.mysql.dbaas.com.br');
/**
 * The username used to connect to the database
 */
define('APP_DB_USERNAME', 'crm_paladini');
/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'Crm_Pala@2105');
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'crm_paladini');
