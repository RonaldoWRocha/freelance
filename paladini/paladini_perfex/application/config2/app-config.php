...
*
*/
define('APP_BASE_URL', 'https://www.paladiniadv.com.br/crm_mgit/');
...
*/
define('APP_ENC_KEY', '2dfb96eedf3ca3558ee15b553e1bda32');

/**
 * Database Credentials
 * The hostname of your database server
 */
define('APP_DB_HOSTNAME', 'crm_mgit.mysql.dbaas.com.br');
/**
 * The username used to connect to the database
 */
define('APP_DB_USERNAME', 'crm_mgit');
/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'Crm_Mgit@0904');
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'crm_mgit');
