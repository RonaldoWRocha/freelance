...
*
*/
define('APP_BASE_URL', 'https://www.paladiniadv.com.br/crm_mgal/');
 ...
 */
define('APP_DB_HOSTNAME', 'crm_mgal.mysql.dbaas.com.br');
/**
 * The username used to connect to the database
 */
define('APP_DB_USERNAME', 'crm_mgal');
/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'Crm_Mgal@0904');
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'crm_mgal');
