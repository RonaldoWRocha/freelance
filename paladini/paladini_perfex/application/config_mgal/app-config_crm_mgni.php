...
*
*/
define('APP_BASE_URL', 'https://www.paladiniadv.com.br/crm_mgni/');
...
*/
define('APP_ENC_KEY', 'cf61838fde3be98b39470c4eab1ff8e2');

/**
 * Database Credentials
 * The hostname of your database server
 */
define('APP_DB_HOSTNAME', 'crm_mgni.mysql.dbaas.com.br');
/**
 * The username used to connect to the database
 */
define('APP_DB_USERNAME', 'crm_mgni');
/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'Crm_Mgni@0904');
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'crm_mgni');
