...
<head>
    ...
    <script type="text/javascript" src="../assets/js/script-boleto.js"></script>
    ...
    <div class="container-fluid">
        <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="col-lg-3">
                ...
                <div class="col-lg-12">
                    <a href="../download/exemplo-boleto.zip" class="btn btn-block btn-default">Baixar este exemplo <br> <img src="../assets/img/cloud-computing.png"></a>
                </div>
