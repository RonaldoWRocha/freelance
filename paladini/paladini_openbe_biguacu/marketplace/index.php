...
<head>
    ...
    <script type="text/javascript" src="../assets/js/script-marketplace.js"></script>
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="../">
                    <img src="https://gerencianet.com.br/wp-content/themes/Gerencianet/images/marca-gerencianet.svg" alt="Gerencianet - Conceito em Pagamentos" width="218" height="31">
                </a>
            </div>
                ...
                <ul class="nav navbar-nav pull-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="../marketplace/">Marketplace (Split -  Boleto)</a></li>
                        </ul>
                    </li>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12">
        <h4>Exemplo de Integração: Marketplace</h4>
    </div>

    <div class="container-fluid">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="col-lg-9">
                <form id="form" method="POST" action="pagar-marketplace.php" class="">
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-2">
                        ...
                        <h6>Cliente 1</h6>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Identificador da conta: (<em class="atributo">payee_code</em>) <br><strong class="ex">Ex: 51e0364ebc8f541ddc160c7b2229e5b1 (<a href="https://cdn.discordapp.com/attachments/652136190006525955/809138574549188618/identificador-conta.jpg" target="_blank">onde localizar?</a>)</strong></label>
                        ...
                        <h6>Cliente 2</h6>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Identificador da conta: (<em class="atributo">payee_code</em>) <br><strong class="ex">Ex: 14e0364ebc8f471aad112c7b2229e5b2 (<a href="https://cdn.discordapp.com/attachments/652136190006525955/809138574549188618/identificador-conta.jpg" target="_blank">onde localizar?</a>)</strong></label>
            ...
            <div class="col-lg-3">
                <div style="margin-top: 20px;" class="col-lg-12">
                    <a href="../download/exemplo-marketplace.zip" class="btn btn-block btn-default">Baixar este exemplo <br> <img src="../assets/img/cloud-computing.png"></a>
                </div>
